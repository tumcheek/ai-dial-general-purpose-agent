...
class FileContentExtractionTool(BaseTool):
    ...
    def parameters(self) -> dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                ...
                "page": {
                    "type": "integer",
                    "description": "For large documents pagination is enabled. Each page consists of 10000 characters. By default 1.",
                    "default": 1
                }
            },
            "required": ["file_url"]
    ...
    async def _execute(self, tool_call_params: ToolCallParams) -> str | Message:
        ...
        content = DialFileContentExtractor(endpoint=self.endpoint, api_key=tool_call_params.api_key).extract_text(file_url=file_url)
        if not content:
